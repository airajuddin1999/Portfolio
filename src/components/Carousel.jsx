          ...
          <div className="flex w-full lg:h-[60vh] md:h-[40vh] h-[60vh] items-center gap-[3vw]">
            {slides.map((slide, index) => (
              <a
                ...
                className="slider-item w-[60vw] h-full flex-none relative block cursor-pointer"
                key={index}
              >
                <img
                  src={slide.img}
                ...
                />
                <div className="absolute bg-zinc-900 w-full h-20 bottom-0 left-0 bg-black-300 bg-opacity-90 px-5">
                  <div className="w-full h-full flex justify-between items-center">
                    ...
                    <div className="flex-center gap-5">
                      ...
                      <img
                        ...
                        alt="arrow"
                        className="md:size-10 size-7 invert"
                      />
                    </div>
                  </div>
                </div>
